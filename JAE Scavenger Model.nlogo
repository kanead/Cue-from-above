...
;; All of the animals have a size value which determines their competitive ability
...
to forage-vul
  ...
  ifelse info-transfer? and any? turtles with [shape = "circle"] in-cone 1 286 [set shape "star"] [set shape "default"]
  ]
...
[ face min-one-of turtles with [shape = "star"] in-cone 1 250 [distance myself]
  ]
